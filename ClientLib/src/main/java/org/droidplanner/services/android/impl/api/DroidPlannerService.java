...
//        startForeground(FOREGROUND_ID, notification);
    ...
    private void createNotificationChannel(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            //put the service in the foreground
            final NotificationCompat.Builder notifiBuilder = new NotificationCompat.Builder(context)
                    .setContentTitle("DroneKit-Android")
                    .setPriority(NotificationCompat.PRIORITY_MIN)
                    .setSmallIcon(R.drawable.ic_stat_notify);
            ...
            final int connectedCount = droneApiStore.size();
            if(connectedCount > 1){
                notifiBuilder.setContentText(connectedCount + "connected apps");
            }

            final Notification notification = notifiBuilder.build();
            startForeground(FOREGROUND_ID,notification);
        }
    }
